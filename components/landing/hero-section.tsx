        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          >
            <p className="text-lg text-[#6b6560] leading-relaxed max-w-lg mb-10 pl-5 border-l-2 border-[#d0ccc5]">
              GGXT Express Cargo L.L.C provides comprehensive logistics services
              including general warehousing, sea cargo transportation, professional
              cargo packaging and customs brokerage for import and export businesses
              across UAE + 23 MENA countries.
            </p>
            ...
            <p className="mt-5 text-xs font-mono text-[#9e9890] uppercase tracking-widest">
              General Warehousing · Sea Cargo · Packaging · Customs Brokerage
            </p>
          </div>
